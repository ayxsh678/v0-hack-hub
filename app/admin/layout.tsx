...
const sidebarItems = [
  ...
  { icon: Wallet, label: "Budget", href: "/admin/budget" },
  { icon: Radio, label: "Walkie Talkie", href: "/admin/walkie-talkie" },
  { icon: Calendar, label: "Event Schedule", href: "/admin/schedule" },
  { icon: Users, label: "Volunteer Updates", href: "/admin/volunteers" },
